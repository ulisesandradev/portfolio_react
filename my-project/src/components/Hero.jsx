...
import profilePic from "../assets/ulisesProfilePic.jpg"
            ...
            <div className="flex flex-wrap">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        <motion.h1 
                            ...
                            initial="hidden"
                            animate="visible"
                            className="pb-10 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Ulises Andrade
                        </motion.h1>
                        <motion.span 
                ...
                <div className="w-full lg:w-1/2 lg:p-8">
                    <div className="flex justify-center">
                        <motion.img style={{borderRadius: '10px', width: '70%'}}
                        initial={{ x: 100, opacity: 0 }}
                        animate={{ x: 0, opacity: 1}}
                        transition={{ duration: 1, delay: 1.2 }}
                        src={profilePic} alt="ulisesphoto"></motion.img>
                    </div>
                </div>
            </div>
